...
class CNN_AE(nn.Module):
    def __init__(self,
        ...
        #He initialisation pre relu activation
        nn.init.kaiming_normal_(self.conv_classifier.weight)
        ...
        if bias:
            ...
            nn.init.zeros_(self.conv_classifier.bias)
    ...
    def classify(self, h):
        ...
        classifier_h = self.activation(self.conv_classifier(h))

        #flatten here
        h_flat = torch.flatten(classifier_h, 1)
